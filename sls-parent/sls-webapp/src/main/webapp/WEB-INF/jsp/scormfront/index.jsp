...
<div class="col-md-2">
    <div class="row">
        ...
        <div class="top-news col-md-12">
            <a class="btn red sliderbar-transparency" onclick="linkScormInfo(21)">
                <span> TOP ONE</span>
                <em>书名</em>
                <em>
            ...
            <a class="btn green" onclick="linkScormInfo(21)">
                <span> TOP TWO</span>
                <em>书名</em>
                <em>
                    <i class="fa fa-tags"></i>
            ...
            <a class="btn blue" onclick="linkScormInfo(21)">
                <span> TOP THREE</span>
                <em>书名</em>
                <em>
                    <i class="fa fa-tags"></i>
            ...
            <a class="btn yellow" onclick="linkScormInfo(21)">
                <span> TOP FOUR</span>
                <em>书名</em>
                <em>
                    <i class="fa fa-tags"></i>
            ...
            <a class="btn purple" onclick="linkScormInfo(21)">
                <span> TOP FIVE</span>
                <em>书名</em>
                <em>
                    <i class="fa fa-tags"></i>
            ...
            <a class="btn red" onclick="linkScormInfo(21)">
                <span> TOP ONE</span>
                <em>书名</em>
                <em>
                    <i class="fa fa-tags"></i>
