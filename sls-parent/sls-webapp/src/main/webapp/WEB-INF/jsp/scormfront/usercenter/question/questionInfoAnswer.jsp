...
<head>
    <meta charset="utf-8"/>
    <title>SLS | AnswerQuestionInfo</title>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-5">
                                        <textarea class="form-control"
                                                  id="askContent">${question.answerContent}</textarea>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="col-md-offset-3 col-md-9">
                                            <a class="btn purple" onclick="changeQuestionAnswerContent()">
    ...
    function changeQuestionAnswerContent() {
        $.ajax({
            ...
            success: function () {
                ...
                top.$("#alertPromptMessage").html("提交成功");
