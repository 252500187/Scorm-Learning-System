            ...
            <div class="page-slider margin-bottom-35">
              ...
              <div id="layerslider" style="width: 100%; height: 494px; margin: 0 auto;">
                  ...
                  <div class="ls-layer ls-layer1" style="slidedirection: right; transition2d: 24,25,27,28; ">
                    <img src="<%=basePath%>assets/temp/sliders/slide1/bg.jpg" class="ls-bg" alt="Slide background">
                  ...
                  <div class="ls-layer ls-layer2" style="slidedirection: right; transition2d: 110,111,112,113; ">
                    <img src="<%=basePath%>assets/temp/sliders/slide2/bg.jpg" class="ls-bg" alt="Slide background">
                  ...
                  <div class="ls-layer ls-layer3" style="slidedirection: right; transition2d: 92,93,105; ">
                    <img src="<%=basePath%>assets/temp/sliders/slide3/bg.jpg" class="ls-bg" alt="Slide background">
                  ...
                  <div class="ls-layer ls-layer5" style="slidedirection: right; transition2d: 110,111,112,113; ">
                    <img src="<%=basePath%>assets/temp/sliders/slide5/bg.jpg" class="ls-bg" alt="Slide background">
                            ...
                            <div class="booking-result">
                                <div class="booking-img">
                                    <div style="position:relative;z-index:2;">
                                        ...
                                        <div style="background-image:url('<%=basePath%>/img/bookmarks/mark2.png');position:absolute; left:250px; top:20px;width: 80px;z-index:-1">
                                            我是分数
                                        </div>
                                        <div style="background-image:url('<%=basePath%>/img/bookmarks/mark2.png');position:absolute; left:250px; top:80px;width: 80px;z-index:-1">
                                            我是标签
                                        </div>
