...
<script src="<c:url value="/js/common/bootstrap-2.3.2/js/bootstrap-datetimepicker.zh-CN.js"/>"
        type="text/javascript"></script>
...
<script src="<c:url value="/js/common/lineEditTable.js"/>" type="text/javascript"></script>
<script src="<c:url value="/js/common/auditTable.js"/>" type="text/javascript"></script>
<script src="<c:url value="/js/common/publicityTable.js"/>" type="text/javascript"></script>
