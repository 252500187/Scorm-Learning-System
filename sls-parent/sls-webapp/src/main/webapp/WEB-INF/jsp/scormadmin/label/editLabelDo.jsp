<%--@elvariable id="label" type="com.sls.system.entity.label"--%>
    ...
    <form class="form-horizontal">
        <fieldset>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <input id="labelName" name="labelName" type="text" value="${label.labelName}"/>
                </div>
            </div>
...
<script>
    ...
    var ruleLabel = {
        objInfo: {
            labelName: {
                ...
                ajax: [basePath + "admin/label/checkRepeatLabelName", {}, {labelName: "$('#labelName').val().trim()", oldLabelName: "'${label.labelName}'"},
                    backFunc, "text", "POST"]
            }
        }
    };
    ...
    function save() {
        ...
        $.ajax({
            url: basePath + "admin/label/editLabel",
            data: {
