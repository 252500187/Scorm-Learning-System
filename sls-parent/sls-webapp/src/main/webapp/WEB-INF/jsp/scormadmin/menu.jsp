            ...
            <ul class="nav" role="navigation">
                <li class="dropdown">
                    <a href="#" id="drop6" role="button" class="dropdown-toggle" data-toggle="dropdown"
                       onclick=" addTab('用户管理','user/user/listAllUserDo')">用户管理</a>
                </li>
                <li class="dropdown">
                    <a href="#" id="drop7" role="button" class="dropdown-toggle" data-toggle="dropdown"
                       onclick=" addTab('角色管理','user/role/listAllRoleDo')">角色管理</a>
                </li>
                <li class="dropdown">
                    <a href="#" id="drop8" role="button" class="dropdown-toggle" data-toggle="dropdown"
                       onclick=" addTab('字典管理','user/dict/listAllDictDefineDo')">字典管理</a>
                </li>
            </ul>
        </div>
    </div>
