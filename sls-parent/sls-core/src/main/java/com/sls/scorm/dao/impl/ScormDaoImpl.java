...
public class ScormDaoImpl extends PageDao implements ScormDao {
    ...
    public int addScorm(Scorm scorm) {
        String sql = "INSERT INTO ss_scorm(scorm_id,scorm_name,register_sum,recommend_level,img_path,upload_user_id,upload_date,in_use) " +
                "VALUES(:scormId, :scormName, :registerSum,:recommendLevel, :imgPath, :uploadUserId, :uploadDate,:inUse)";
