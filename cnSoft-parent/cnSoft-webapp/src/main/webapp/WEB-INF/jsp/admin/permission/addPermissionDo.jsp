...
--%>
<%--@elvariable id="permissionList" type="List<com.genghis.ptas.security.entity.Permission>"--%>
...
<head>
    ...
    <title><spring:message code="permission"/><spring:message code="add"/></title>
</head>
<body>
<div id="mainContent">
    <form class="form-horizontal">
        <fieldset>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <input type="text" name="permissionToken" id="permissionToken" value=""/>
                </div>
            </div>

            <div class="control-group">
                <label class="control-label" for="description"><spring:message code="permission"/><spring:message
    ...
    var rulePermission = {
        objInfo: {
            permissionToken: {
                ...
                ajax: [basePath + "admin/permission/checkRepeatPermissionToken", {}, {permissionToken: "$('#permissionToken').val().trim()"},
                    backFunc, "text", "POST"]
            },
            description: {
